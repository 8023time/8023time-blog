...
export function Tiktok(props: SVGProps<SVGSVGElement>) {
  return (
    <svg xmlns='http://www.w3.org/2000/svg' width='100%' height='100%' viewBox='0 0 14 14' {...props}>
      <path
        fill='currentColor'
        fillRule='evenodd'
        clipRule='evenodd'
...
const TiktokIcon: React.FC<IconWrapperProps> = (props) => {
  return <Icon icon={<Tiktok />} {...props} />;
};
