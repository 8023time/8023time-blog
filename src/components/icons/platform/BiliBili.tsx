...
export function BiliBili(props: SVGProps<SVGSVGElement>) {
  return (
...
const BiliBiliIon: React.FC<IconWrapperProps> = (props) => {
  return <Icon icon={<BiliBili />} {...props} />;
};

export default BiliBiliIon;
