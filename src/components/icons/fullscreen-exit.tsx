...
export function FullscreenExit(props: SVGProps<SVGSVGElement>) {
  return (
    <svg xmlns='http://www.w3.org/2000/svg' width='100%' height='100%' viewBox='0 0 1024 1024' {...props}>
      <path
        fill='currentColor'
...
const FullscreenExitIcon: React.FC<IconWrapperProps> = (props) => {
  return <Icon icon={<FullscreenExit />} {...props} />;
};
