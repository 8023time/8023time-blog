...
export function SunRise(props?: SVGProps<SVGSVGElement>) {
  return (
    <svg width='100%' height='100%' viewBox='0 0 24 24' className='fill-black/40 dark:fill-gray-400' {...props}>
      <g fill='none' stroke='currentColor' strokeLinecap='round' strokeLinejoin='round' strokeWidth={2}>
        <circle cx='12' cy='32' r='6' fill='currentColor' fillOpacity={0.3}>
        ...
        <g>
          <path strokeDasharray='2' strokeDashoffset='2' d='M12 19v1M19 12h1M12 5v-1M5 12h-1'>
            <animate
              ...
              begin='0.7s'
              dur='0.2s'
              values='M12 19v1M19 12h1M12 5v-1M5 12h-1;
                      M12 21v1M21 12h1M12 3v-1M3 12h-1'
            />
          ...
          <path strokeDasharray='2' strokeDashoffset='2' d='M17 17l0.5 0.5M17 7l0.5 -0.5M7 7l-0.5 -0.5M7 17l-0.5 0.5'>
            <animate
              ...
              begin='0.9s'
              dur='0.2s'
              values='M17 17l0.5 0.5M17 7l0.5 -0.5M7 7l-0.5 -0.5M7 17l-0.5 0.5;
                      M18.5 18.5l0.5 0.5M18.5 5.5l0.5 -0.5M5.5 5.5l-0.5 -0.5M5.5 18.5l-0.5 0.5'
            />
